...
### 第一步授权：pod trunk register sonywuyang@163.com 'liangsay'

### 发布：pod trunk push WUImagePickerController.podspec
### pod trunk push WUImagePickerController.podspec  --allow-warnings --verbose
pod spec lint WUImagePickerController.podspec --verbose
<!-- 如果pod依赖了其他库,需要添加--user-libraries -->
pod repo push GaoRepo WUImagePickerController.podspec  --allow-warnings --verbose --use-libraries
